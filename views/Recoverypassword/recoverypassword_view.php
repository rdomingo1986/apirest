...
<html lang="en">
	...
	<body>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										...
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Recovery Password</h3>
										</div>	
										<div class="form-wrap">
											<form action="#" id="recoverypassword-form">
												...
												<div class="form-group">
													...
													<input type="password" class="form-control" id="passwordRepeat" name="passwordRepeat"  placeholder="Re-Enter pwd">
												</div>
		...
		<!-- JavaScript -->
		<script>
			var recoveryPasswordCode = '<?= $passwordResetCode;?>';
		</script>
		<!-- jQuery -->
    ...
    <script src="<?= base_url();?>src/js/Recoverypassword/recoverypassword_view.js"></script>
